    ...
    {#if data.Neck_Thikness}
        <Wrapper label={$LOCALE.NECKTHICK_TITLE}>
            <svelte:fragment slot="primary-start"
                >{$LOCALE.THICKNESS_SUBTITLE}</svelte:fragment
            >
    ...
    {#if data.Nose_Width}
        <Wrapper label={$LOCALE.NOSE_TITLE}>
            <svelte:fragment slot="default">
                <div class="w-full text-end text-white">
                    <p>
                        {$LOCALE.PEAKHEIGHT_SUBTITLE} & {$LOCALE.WIDTH_SUBTITLE}
                    </p>
                    <p>
                        {$LOCALE.BONEHEIGHT_SUBTITLE} & {$LOCALE.PEAKLENGTH_SUBTITLE}
                    </p>
                    <p>
                        {$LOCALE.BONETWIST_SUBTITLE} & {$LOCALE.PEAKLOWERING_SUBTITLE}
                    </p>
                </div>
            </svelte:fragment>
            <svelte:fragment slot="primary">
    ...
    {#if data.EyeBrown_Height}
        <Wrapper label={$LOCALE.EYEBROW_TITLE}>
            <svelte:fragment slot="default">
                <div class="w-full text-end text-white">
                    <p>
                        {$LOCALE.DEPTH_SUBTITLE} & {$LOCALE.HEIGHT_SUBTITLE}
                    </p>
                </div>
            </svelte:fragment>
            <svelte:fragment slot="primary">
    ...
    {#if data.Cheeks_Bone_High}
        <Wrapper label={$LOCALE.CHEEKS_TITLE}>
            <svelte:fragment slot="default">
                <div class="w-full text-end text-white">
                    <p>
                        {$LOCALE.BONEWIDTH_SUBTITLE} & {$LOCALE.BONEHEIGHT_SUBTITLE}
                    </p>
                </div>
            </svelte:fragment>
            <svelte:fragment slot="primary">
            ...
            <svelte:fragment slot="extra_primary-start"
                >{$LOCALE.WIDTH_SUBTITLE}</svelte:fragment
            >
        ...
        {#if data.Eyes_Openning}
            <Wrapper label={$LOCALE.EYES_TITLE}>
                <svelte:fragment slot="primary-start"
                    >{$LOCALE.SQUINT_SUBTITLE}</svelte:fragment
                >
        ...
        {#if data.Jaw_Bone_Width}
            <Wrapper label={$LOCALE.JAW_TITLE}>
                <svelte:fragment slot="default">
                    <div class="w-full text-end text-white">
                        <p>
                            {$LOCALE.BONELENGHT_SUBTITLE} & {$LOCALE.BONEWIDTH_SUBTITLE}
                        </p>
                    </div>
                </svelte:fragment>
                <svelte:fragment slot="primary">
        ...
        {#if data.Chin_Bone_Lowering}
            <Wrapper label={$LOCALE.CHIN_TITLE}>
                <svelte:fragment slot="default">
                    <div class="w-full text-end text-white">
                        <p>
                            {$LOCALE.BONELENGHT_SUBTITLE} & {$LOCALE.BONELOWERING_SUBTITLE}
                        </p>
                        <p>
                            {$LOCALE.HOLE_SUBTITLE} & {$LOCALE.BONEWIDTH_SUBTITLE}
                        </p>
                    </div>
                </svelte:fragment>
                <svelte:fragment slot="primary">
        ...
        {#if headOverlay?.Blemishes?.overlayValue !== null}
            <Wrapper label={$LOCALE.BLEMISHES_SUBTITLE}>
                <svelte:fragment slot="primary-start"
                    >{$LOCALE.DESIGN_SUBTITLE}</svelte:fragment
                >
                <svelte:fragment slot="primary">
                    <NumberStepper
